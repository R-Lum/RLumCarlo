...
output.file <- paste0("RLumCarlo.BuildResults/RLumCarlo_",temp.version,"-Functions.html")

##exclude package itself
file.list.man <- file.list.man[which(file.list.man!="RLumCarlo-package.Rd")]
...
HTML(paste("<h2 align=\"center\">Major functions in the R package 'RLumCarlo'</h2>
...
write.table(output,
            file =  paste0("RLumCarlo.BuildResults/RLumCarlo_",temp.version,"-Functions.csv"),
            sep = ",", row.names = FALSE)
...
write(print(latex.table),
      file =  paste0("RLumCarlo.BuildResults/RLumCarlo_",temp.version,"-Functions.tex"))
