...
1 & calc\_RLumCarlo & Plot results from Monte-Carlo simulations with RLumCarlo & $<$br /$>$ Plot results from Monte-Carlo simulations with RLumCarlo$<$br /$>$ & 0.0.1 & [2017-01-27]
 ...
 &  & $<$br /$>$ Johannes Friedrich, University of Bayreuth (Germany)$<$br /$>$ \\ 
  6 & run\_MC\_TL\_DELOC & Run Monte-Carlo simulation for TL for GOT model & $<$br /$>$ \#\#TODO$<$br /$>$ & 0.0.1
 &  &  & $<$br /$>$ Sebastian Kreutzer, IRAMAT-CRP2A, UMR 5060, CNRS - Université Bordeaux Montaigne (France)$<$br /$>$ \\ 
  7 & run\_MC\_TL\_LOC & Run Monte-Carlo simulation for TL for localised transition & $<$br /$>$ \#\#TODO$<$br /$>$ & 0.0.1
 &  &  & $<$br /$>$ Sebastian Kreutzer, IRAMAT-CRP2A, UMR 5060, CNRS - Université Bordeaux Montaigne (France)$<$br /$>$ \\ 
  8 & run\_MC\_TL & Run Monte-Carlo simulation for TL & $<$br /$>$ Run Monte-Carlo simulation for TL$<$br /$>$ & 0.0.1 & [2017-01-27]
 &  & $<$br /$>$ Johannes Friedrich, University of Bayreuth (Germany)$<$br /$>$ \\ 
   \hline
\end{tabular}
\end{table}
