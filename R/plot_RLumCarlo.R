...
#'
#' @description The function allows to visualise 'RLumCarlo' modelling results without
#' extracting the values manually. Typically visualised values are the signal or the number of remaining electrons
#' as averaged values with a polygon indicating modelling uncertainties.
#'
#' @details The colour curves, the package [khroma::khroma-package] is used to provide colours
...
#' usually the required input object is generated by one for the functions preceeding with `run`.
...
#' The arguments `lwd`, `type`, `pch`, `lty`, `col` can be provided as vector if `object` is a [list]
#'
