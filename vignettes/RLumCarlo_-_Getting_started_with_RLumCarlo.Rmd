...
author: "Sebastian Kreutzer, Johannes Friedrich, Vasilis Pagnis, Christoph Schmidt"
...
knitr::include_graphics("../docs/img/Logo_RLumCarlo.png")
...
| Model | R-file | C++ file | Function to call |
|----------|-------------|--------------|------------------|
TL$_{DELOC}$ | `run_MC_TL_DELOC.R` | `MC_C_TL_DELOC.cpp` | `run_MC_TL_DELOC()`|
ITL$_{DELOC}$ | `run_MC_ISO_DELOC.R` | `MC_C_ISO_DELOC.cpp` | `run_MC_ISO_DELOC()`|
CW-IRSL$_{DELOC}$ | `run_MC_CW_IRSL_DELOC.R` | `MC_C_CW_IRSL_DELOC.cpp` | `run_MC_CW_IRSL_DELOC()`|
LM-OSL$_{DELOC}$ | `run_MC_LM_OSL_DELOC.R` | `MC_C_LM_OSL_DELOC.cpp` | `run_MC_LM_OSL_DELOC()`|
